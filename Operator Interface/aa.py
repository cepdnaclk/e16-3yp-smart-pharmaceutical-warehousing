...
def ShowLoginForm():
    global loginform
    loginform = Toplevel()
    loginform.title("Operator GUI/Account Login")
    width = 600
    height = 500
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
def Home():
    ...
    Title.pack(pady=10)
    lbl_display = Label(Title, text="AAA", font=('arial', 45))
    lbl_display.pack()
    menubar = Menu(Home)
    ...
    filemenu2.add_command(label="View", command=ShowViewOrder)
    filemenu3.add_command(label="View", command=ShowViewAGV)
    ...
    menubar.add_cascade(label="Location")
...
# ========================================LABEL WIDGET=====================================
lbl_display = Label(Title, text="Operator Management", font=('arial', 45))
lbl_display.pack()
