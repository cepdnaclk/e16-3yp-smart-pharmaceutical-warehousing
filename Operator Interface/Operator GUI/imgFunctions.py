...
def loadBackground(girdSize, WINDOW_SIZE):
    # TODO - handle errors
    Orig = cv2.imread('/home/dell/Desktop/Operator GUI/resources/simbot_back-racks.jpg')
...
def loadBotImgs(girdSize, WINDOW_SIZE):
    ...
    for item in items:
        img = cv2.imread('/home/dell/Desktop/Operator GUI/resources/simbot_%s.png'%item, cv2.IMREAD_UNCHANGED)
